...
def frequency_analysis(
    c: str,
    reference_distribution: Union[
        List[str], List[Tuple[str, float]], Alphabet, None
    ] = None,
) -> Dict[str, str]:
    reference_distribution = Alphabet(alphabet=reference_distribution)
    ciphertext_distribution = frequency_distribution(
        m=c.upper(), alphabet=reference_distribution.alphabet
    )
    ...
    substitution_mapping = {
        ...
        for ciphertext, plaintext in zip(ciphertext_ordered, referencetext_ordered)
    }
