...
**There is no direct or systematic path from identifying assets to identifying threats.** Time spent cataloguing assets can detract from actually discovering and mitigating threats.
