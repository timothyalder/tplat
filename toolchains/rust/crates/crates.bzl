...
# buildifier: disable=bzl-visibility
load("//toolchains/rust/crates:defs.bzl", _crate_repositories = "crate_repositories")
...
def crate_repositories():
    ...
    maybe(
        ...
        name = "vendor",
        build_file = Label("//toolchains/rust/crates:BUILD.bazel"),
        defs_module = Label("//toolchains/rust/crates:defs.bzl"),
    )
