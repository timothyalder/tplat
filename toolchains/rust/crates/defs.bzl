...
#
#     bazel run @@//toolchains/rust:vendor
###############################################################################
"""
...
_NORMAL_DEPENDENCIES = {
    "toolchains/rust": {
        _COMMON_CONDITION: {
            "anyhow": Label("@vendor//:anyhow-1.0.101"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//toolchains/rust/crates:BUILD.anyhow-1.0.101.bazel"),
    )

    return [
        struct(repo = "vendor__anyhow-1.0.101", is_dev_dep = False),
    ]
