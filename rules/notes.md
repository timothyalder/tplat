...
Want to:
* Create a folder with site name. Copy the site index file there. Copy and source .md files there.
* For any sections that are srcs for the site, create a folder for the section. Folder name should be projects/translate/docs -> projects_translate_docs
* For any sections that are srcs of sections, create a folder for the section inside the parent section folder. etc.